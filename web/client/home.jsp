                    ...
                    <div class="filter-body" >
                        <div class="filter-film">
                            <ul>
                                ...
                                <li><a href=""> Phim hồng kong</a></li>
                                <li><a href=""> Phim nhật</a> </li>
                                <li><a href=""> Phim hàn</a> </li>
                            </ul>
                            <ul>
                            ...
                            <ul>
                                ...
                                <li><a href=""> Phim khoa  học VT</a>  </li>
                                <li><a href=""> Phim tâm lý</a>  </li>
                                <li><a href=""> Phim gia đình</a>  </li>
                            </ul>
                            <ul>
                                <li><a href=""> TV show</a> </li>
                                <li><a href=""> Phim dài tập</a>  </li>
                    ...
                    <div class="logo" style="margin-top: 20px; width: 50%; ; ">
                        <a href="home.html">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/0/08/Netflix_2015_logo.svg"
                                alt="Netflix Logo" style="width: 250px; margin-bottom: 10px;">
                        </a>
                    ...
                    <div class="grid_row-12" style="margin-top: 20px; width: 23%;">
                        <ul style="margin-top: 20px; list-style: none; padding-left: 0; font-size: 1rem;">
                            <li><a style="text-decoration: none; color: #fff;"
                                    href="https://www.facebook.com/lecongnam0604/"><i style=" margin-right: 10px; "
                                        class="fa-brands fa-facebook"></i> facebook</a></li>
                            <li><a style="text-decoration: none; color: #fff;"
                                    href="https://www.instagram.com/namlc0604/"><i style=" margin-right: 10px; "
                                        class="fa-brands fa-instagram"></i>instagram</a></li>
                            <li><a style="text-decoration: none; color: #fff;"
                                    href="https://drive.google.com/drive/u/0/my-drive"><i style=" margin-right: 10px; "
                                        class="fa-regular fa-envelope"></i>gmail</a></li>
                            <li><a style="text-decoration: none; color: #fff;" href="" title="0961256092"><i
                                        style=" margin-right: 10px; " class="fa-solid fa-phone"></i>phone number</a>
                            </li>
